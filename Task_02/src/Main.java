...
//                if (ship[j-1].getPassenger1f().compareTo(ship[j].getPassenger1f())>0){
//                    temp = (ship[j-1].getPassenger1f());
//                    ship[j-1] = ship[j];
//                    ship[j].getPassenger1f() = temp;
//                }
//            }
//        }
//        for (Cabin s: ship){
...
//    }
    ...
    public static void totalExpenses(){      // view each passenger's expenses and total expenses of the cabin by cabin no.
        System.out.println("Enter cabin number (0-11) to view expenses :");
        cabinNum = input.nextInt();
